...
void QSpdLog::setMaxEntries(nonstd::optional<std::size_t> maxEntries)
{
    _sourceModel->setMaxEntries(maxEntries);
}

nonstd::optional<std::size_t> QSpdLog::getMaxEntries() const
{
...
nonstd::optional<QColor> QSpdLog::getLoggerForeground(nonstd::string_view loggerName
) const
{
...
nonstd::optional<QBrush> QSpdLog::getLoggerBackground(nonstd::string_view loggerName
) const
{
...
nonstd::optional<QFont> QSpdLog::getLoggerFont(nonstd::string_view loggerName) const
{
